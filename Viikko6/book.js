const book = {
    ...
    getOneBook: function(bname) {
        const fBook = this.bookArray.find(book => book.name === bname);
        console.log(fBook);
    },
    addBook: function(id_book, name, author, isbn) {
        ...
        this.bookArray.push(addBook)
        console.log("Added book: "+id_book, name, author, isbn);
    }
};

book.getAllBooks();
book.getOneBook('Photography');
book.addBook("16", "Kirjanhoito-opas", "Pertti", "9780073376854");
book.getAllBooks();